...
<div class="container" align="center">
      <h1 style="color:blue;"><i>Profile-Edit</i></h1>
  </div>
  ...
  <label>
    ...
    <input type="text" name="username" class="input" required="" value="{{$acc['username']}}">
    <div class="line-box">
      <div class="line"></div>
    </div>
  </label>
  <label>
    ...
    <input type="text" name="password" class="input" required="" value="{{$acc['password']}}">
    <div class="line-box">
      <div class="line"></div>
    </div>
  </label>
