...
<div class="container" align="center">
      <h1 style="color:blue;"><i>Service-Edit</i></h1>
  </div>
  
   <form method="post">
{{ csrf_field() }}
  <label>
    <p class="label-txt">Enter Head Line</p>
    <input type="text" name="head" class="input" value="{{$acc['head']}}">
    <div class="line-box">
      <div class="line"></div>
    </div>
  </label>
  <label>
    <p class="label-txt">Enter Your Service Deails</p>
    <textarea cols="100" rows="10" name="details" value="{{$acc['details']}}" ></textarea>
    <div class="line-box">
      <div class="line"></div>
    </div>
  </label>
