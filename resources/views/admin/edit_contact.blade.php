...
<div class="container" align="center">
      <h1 style="color:blue;"><i>Contact-Informaion</i></h1>
  </div>
...
{{ csrf_field() }}
  <label>
    ...
    <input type="text" name="add" class="input" required="" value="{{$acc['address']}}" >
    <div class="line-box">
      <div class="line"></div>
    </div>
  </label>
  <label>
    ...
    <input type="text" name="email" class="input" required="" value="{{$acc['email']}}" >
    <div class="line-box">
      <div class="line"></div>
    </div>
  </label>
  <label>
    ...
    <input type="text" name="mobile" class="input" required="" value="{{$acc['mobile']}}" >
    <div class="line-box">
      <div class="line"></div>
    </div>
  </label>
