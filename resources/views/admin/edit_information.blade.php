...
{{ csrf_field() }}
  <label>
    <p class="label-txt">Enter Your Project Number</p>
    <input type="text" name="pro" class="input" required="" value="{{$acc['pro']}}">
    <div class="line-box">
      <div class="line"></div>
    </div>
  </label>
  <label>
    <p class="label-txt">Enter Your Customer Number</p>
    <input type="text" name="cus" class="input" required="" value="{{$acc['cus']}}">
    <div class="line-box">
      <div class="line"></div>
    </div>
  </label>
  <label>
    <p class="label-txt">Enter Your Awward Number</p>
    <input type="text" name="aww" class="input" required="" value="{{$acc['aww']}}">
    <div class="line-box">
      <div class="line"></div>
    </div>
  </label>
  <label>
    <p class="label-txt">Enter Your Experience</p>
    <input type="text" name="exp" class="input" required="" value="{{$acc['exp']}}">
    <div class="line-box">
      <div class="line"></div>
    </div>
  </label>
