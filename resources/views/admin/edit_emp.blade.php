...
<div class="container" align="center">
      <h1 style="color:blue;"><i>Employee-Information-Edit</i></h1>
  </div>
...
{{ csrf_field() }}
  <label>
    ...
    <input type="text" name="name" class="input" required="" value="{{$acc['name']}}">
    <div class="line-box">
      <div class="line"></div>
    </div>
  </label>
  <label>
    <p class="label-txt">Enter Employee Designation</p>
    <input type="text" name="des" class="input" required="" value="{{$acc['des']}}">
    <div class="line-box">
      <div class="line"></div>
    </div>
  </label>
  <label>
    <p class="label-txt">Enter Employee Education</p>
    <input type="text" name="edu" class="input" required="" value="{{$acc['edu']}}">
    <div class="line-box">
      <div class="line"></div>
    </div>
  </label>
  <label>
   ...
   <button class="btn3" type="submit"><i class="fa fa-upload"></i>Save</button><br/>
</form>
