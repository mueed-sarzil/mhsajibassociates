...
<html lang="en">
  <head>
    <title>About|M.H.Sajib & Associates</title>
    <meta charset="utf-8">
    ...
    <form>
	  ...
	  <div class="bg-top navbar-light">
    	<div class="container">
          ...
          <div  align="center"><a  href=""><img src="/images/logo.jpg"  width="25%" ></a></div>
            <!-- <div class="col-md d-flex topper align-items-center align-items-stretch py-md-4"> -->
                ...
                <div class="text">
                  ...
                  <span><b> &nbsp;mh.sajib.associates@gmail.com</b> &nbsp; &nbsp; </span>
                </div>
                ...
                <div class="text">
                  ...
                  <span>&nbsp;<b>Call Us: +880186555651</b></span>
                </div>
	    ...
	    <div class="container d-flex align-items-center px-4">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav mr-auto">
	        	<li class="nav-item"><a href="{{route('home.index')}}" class="nav-link pl-0">Home</a></li>
	        	<li class="nav-item active"><a href="{{route('home.about')}}" class="nav-link">About</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href="{{route('home.index')}}">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>About us <i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
