...
<html lang="en">
  <head>
    <title>Contact|M.H.Sajib & Associates</title>
    <meta charset="utf-8">
          ...
          <div  align="center"><a  href=""><img src="/images/logo.jpg"  width="25%" ></a></div>
            <!-- <div class="col-md d-flex topper align-items-center align-items-stretch py-md-4"> -->
    			...
    			<!-- <div class="col-md-4 d-flex align-items-center py-4">
    				<a class="navbar-brand" href="">Consolution</a>
    			</div>
	    ...
	    <div class="container d-flex align-items-center px-4">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav mr-auto">
	          ...
	          <li class="nav-item active"><a href="{{route('home.contact')}}" class="nav-link">Contact</a></li>
	        </ul>
	      </div>
	    </div>
	  </nav>
